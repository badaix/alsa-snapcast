...
static constexpr auto LOG_TAG = "Uri";
...
void Uri::parse(const std::string& stream_uri)
{
    ...
    // LOG(DEBUG, LOG_TAG) << "Uri decoded: " << decodedUri << "\n";
    ...
    LOG(DEBUG, LOG_TAG) << "Uri.toString: " << toString() << "\n";
}
...
std::string Uri::getQuery(const std::string& key, const std::string& def) const
{
